class MoviesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movie.save
        format.html { redirect_to movie_url(@movie), notice: "Pelicula Creada Correctamente" }
  ...
  def update
    respond_to do |format|
      if @movie.update(movie_params)
        format.html { redirect_to movie_url(@movie), notice: "Pelicula Actualizada Correctamente" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to movies_url, notice: "Pelicula Eliminada Correctamente" }
